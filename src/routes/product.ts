...
import {test, createProduct, getProducts, getProductById, updateProduct, deleteProduct, getProductsByFilters, getProductsBySeller} from '../controllers/product.controller';
